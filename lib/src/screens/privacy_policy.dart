              ...
              child: SingleChildScrollView(
                  ...
                  data: """
                    <h2 style="text-align: center;"><b>PRIVACY POLICY</b></h2>
                            <p>Effective date: 2020-06-10</p>
                            <p>1. <b>Introduction</b></p>
                            <p>Welcome to <b> work-witness.app</b>.</p>
                            <p><b>work-witness.app</b> (“us”, “we”, or “our”) operates <b>work-witness.app</b> (hereinafter referred to as
                              <b>“Service”</b>).</p>
                            <p>Our Privacy Policy governs your visit to <b>work-witness.app</b>, and explains how we collect, safeguard and
                            ...
                            <p><b>SERVICE</b> means the work-witness.app website operated by work-witness.app.</p>
                            ...
                            <p>We may use your Personal Data to contact you with newsletters, marketing or promotional materials and other
                              ...
                              from us by following the unsubscribe link.</p>
                            <p><b>Usage Data</b></p>
                            ...
                            <p>We may use and store information about your location if you give us permission to do so (<b>“Location
                                Data”</b>). We use this data to provide features of our Service, to improve and customize our Service.</p>
                            ...
                            <p>While using our Service, we may also collect the following information: sex, age, date of birth, place of
                              ...
                              agreements, <a href="https://policymaker.io/non-disclosure-agreement/">non-disclosure agreements</a>,
                              information on bonuses and compensation, information on marital status, family members, social security (or
                              other taxpayer identification) number, office location and other data.</p>
                            <p>5. <b>Use of Data</b></p>
                            <p>work-witness.app uses the collected data for various purposes:</p>
                            ...
                            <p>Your information, including Personal Data, may be transferred to – and maintained on – computers located
                              ...
                              differ from those of your jurisdiction.</p>
                            <p>If you are located outside USA and choose to provide information to us, please note that we transfer the
                              data, including Personal Data, to USA and process it there.</p>
                            <p>Your consent to this Privacy Policy followed by your submission of such information represents your agreement
                              to that transfer.</p>
                            <p>work-witness.app will take all the steps reasonably necessary to ensure that your data is treated securely
                              and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an
                              organisation or a country unless there are adequate controls in place including the security of your data and
                            ...
                            <p> If you wish to be informed what Personal Data we hold about you and if you want it to be removed from our
                              systems, please email us at <b>support@work-witness.app</b>.</p>
                            ...
                            <p>CalOPPA is the first state law in the nation to require commercial websites and online services to post a
                              ...
                              collected and those individuals with whom it is being shared, and to comply with this policy.</p>
                            ...
                            <p>0.4. users are able to change their personal information by emailing us at <b>support@work-witness.app</b>.
                            </p>
                            ...
                            <p><b>0.3. To stop selling your personal information. We don’t sell or rent your personal information to any
                                third parties for any purpose. We do not sell your personal information for monetary consideration. However,
                                under some circumstances, a transfer of personal information to a third party, or within our family of
                                companies, without monetary consideration may be considered a “sale” under California law. You are the only
                                owner of your Personal Data and can request disclosure or deletion at any time.</b></p>
                            ...
                            <p>Please note, if you ask us to delete or stop selling your data, it may impact your experience with us, and
                              you may not be able to participate in certain programs or membership services which require the usage of your
                            ...
                            <p>To exercise your California data protection rights described above, please send your request(s) by email:
                              <b>support@work-witness.app</b>.</p>
                            ...
                            <p>For example, the outlined Privacy Policy has been made using <a
                                href="https://policymaker.io/">PolicyMaker.io</a>, free tool that helps create high-quality legal documents.
                              PolicyMaker’s free online <a href="https://policymaker.io/privacy-policy/">privacy policy generator</a> is an
                            ...
                            <p style="margin-top: 5em; font-size: 0.7em;">This <a href="https://policymaker.io/privacy-policy/">Privacy
                                Policy</a> was created for <b>work-witness.app</b> by <a href="https://policymaker.io">PolicyMaker.io</a> on
                              2020-06-10.</p>
                          </div>
                  """,
                  style: {
                    'p': Style(color: Colors.black87, backgroundColor: Colors.white),
                    'h2': Style(color: Colors.black87, backgroundColor: Colors.white),
                  },
                  onLinkTap: (url) {
                ...
                children: [
                  InkWell(
                    ...
                    child: Container(
                      ...
                      child: Center(child: Text('I agree', style: TextStyle(color: Colors.white),))
                    ),
                  ),
                  InkWell(
                    onTap: () {
                    ...
                    child: Container(
                      ...
                      child: Center(child: Text('I disagree', style: TextStyle(color: Colors.white),))
                    ),
                  )
                ],
              ),
